// ReportDetailsPage.jsx (Adjusted for new layout requirements)
         ...
         return (
            <div className='report-details-container'>
                <div className="no-task-selected">
                    <Info size={24} style={{ marginRight: '10px' }} />
                    Report not found.
                    <button onClick={() => navigate("/employee-dashboard/my-reports")} className="back-button" style={{marginLeft: '10px'}}>
    ...
    return (
        <div className="report-details-container">
            ...
            <div className="report-breadcrumb">
                <button onClick={() => navigate("/employee-dashboard/my-reports")} className="back-button">
                    <ChevronLeft size={20} />
                    My Reports
                </button>
